...
INSERT ALL
    INTO review (reviewID, reviewMessage, rating, userID, appID) VALUES (1, 'phillip chariot', '123-435-1239', 'philipchariot@gmail.com')
    INTO review (reviewID, reviewMessage, rating, userID, appID) VALUES (2, 'jared chinatown', '132-421-8123', 'jc@gmail.com')
    INTO review (reviewID, reviewMessage, rating, userID, appID) VALUES (3, 'alejandro mexico', '213-489-1293', 'am@gmail.com')
    INTO review (reviewID, reviewMessage, rating, userID, appID) VALUES (4, 'lipa dua', '213-423-4823', 'dualipa@gmail.com')
    INTO review (reviewID, reviewMessage, rating, userID, appID) VALUES (5, 'chess crackers', '123-483-9123', 'cc@gmail.com')
SELECT 1 FROM DUAL;

    (1, 'Awesome experience', 5, 1)
    (2, 'Not awesome experience', 3, 2)
    (3, 'Liked this salon', 4, 3)
    (4, 'Will not come back', 2, 4)
    (5, 'Not satisfied', 2, 5)
